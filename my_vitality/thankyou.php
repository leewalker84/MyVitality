...
<meta name="description" content="A confirmation of your email"> <!-- define the description of web page -->
...
<body>
    ...
    <main id="container">
        ...
        <article id="mainArticle">
            <h1 class="mainArticleHead">THANK YOU</h1>
            <p class="mainArticleText">Your message was recieved.<br>
                We will try to respond within 24 hours
                <h3>Message Details</h3>
                Name: <?php if (isset($name)) {
                                echo htmlspecialchars($name);
                            } ?>
                <br>
                Email: <?php if (isset($email)) {
                                echo htmlspecialchars($email);
                            } ?>
                <br>
                Message:  <?php if (isset($message)) {
