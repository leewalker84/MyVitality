...
<meta name="description" content="An overview of one of our suppliers supplements"> <!-- define the description of web page -->
...
<body>
    ...
    <main id="container">
        ...
        <div id="main-section">
            ...
            <h1>SUPPLIER</h1>
            <nav class="navSearch">
                <form class="search_form" action="index.php?action=supplier" method="post"> <!-- search_form -->
