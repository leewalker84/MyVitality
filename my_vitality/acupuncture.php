...
if ($action == NULL) {
    ...
    if ($action == NULL) {
        header('Location: .?action=acupuncture');
    }
}
...
<head>
<title>My Vitality - Acupuncture</title> <!-- defines title in browser, title for page when bookmarked, title for page in search engine results -->
...
<meta name="description" content="Information about the accupunture treatments we offer"> <!-- define the description of web page -->
...
<body>
    ...
    <main id="container">
        ...
        <article id="mainArticle">
            <h1 class="mainArticleHead">ACUPUNCTURE</h1>
            <p class="mainArticleText">Acupuncture is a component of traditional Chinese medicine.
                Acupuncture helps balance the flow of energy within your body. This new energy balance stimulates the body’s healing abilities.
                Acupuncture stimulates the nerves and muscles.
                This helps boost the body’s response to pain, and improves blood circulation.
            </p>
        </article>

        <section id="columnOne" class="info">
            <h4 class="info-head">Musculoskeletal and Neurological disorders</h4>
            <figure class="img">
                <i class="glyphicon glyphicon-pushpin icon_image_no_link"></i>
            </figure>
            <p class="info-text">Musculoskeletal disorders and the related pain are major causes of disability. Acupuncture is commonly used for pain relief.
                For musculoskeletal and neurological disorders acupuncture offer treatments for arthritis, fibromyalgia, pain relief, sports performance, stroke rehab.</p>
        </section>

        <section id="columnTwo" class="info">
            <h4 class="info-head">Migraines & Headaches</h4>
            <figure class="img">
                <i class="glyphicon glyphicon-pushpin icon_image_no_link"></i>
            </figure>
            <p class="info-text">Acupuncture is commonly used in Chinese medicine to relieve migraine pain. Acupuncture is tied to a persistent reduction in headache frequency.
                Acupuncture helps reduce days with migraines and may have lasting effects.</p>
        </section>
        ...
        <section id="columnThree" class="info">
            ...
            <p class="info-text">Acupuncture is used to treat many different diseases, disorders and pain conditions. Common ailments that respond well to acupuncture include:
                tendinitis, chronic pain, chronic fatigue syndrome, respiratory disorders, skin problems, dysmenorrhea and digestive disorders.</p>
        </section>
