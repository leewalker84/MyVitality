...
<body>
    ...
    <nav id="navHeader">
        <ul class="nav">
            <!-- redirect to the controller page for section of site and include action attribute so it can be directed appropriatley
                "index.php?action= "
            -->
    ...
    <article id="mainArticle">
        <h1 class="mainArticleHead">A NATURAL WAY TO IMPROVE YOUR HEALTH</h1>
        <p class="mainArticleText">MyVitality is a specialized alternative health care centre,
            designed and crafted around the needs of Gauteng’s community, in the areas of acupuncture,
            herbal therapy and dietary therapy. We offer personalized services at the centre as well as
            a wide range of speciality products for sale at our online store.
        </p>
    </article>
