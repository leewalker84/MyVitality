...
if ($action == NULL) {
    ...
    if ($action == NULL) {
        header('Location: .?action=dietary');
    }
}
...
<head>
<title>My Vitality - Dietary Treatment</title> <!-- defines title in browser, title for page when bookmarked, title for page in search engine results -->
...
<meta name="description" content="Information about the dietary treatments we offer"> <!-- define the description of web page -->
...
<body>
    ...
    <main id="container">
        ...
        <article id="mainArticle">
            <h1 class="mainArticleHead">DIETARY THERAPY</h1>
            <p class="mainArticleText">Diet therapy is a broad term for the practical application of nutrition as a preventative or corrective treatment of disease.
        ...
        <section id="columnOne" class="info">
            <h4 class="info-head">Weight loss</h4>
            <figure class="img">
                <i class="glyphicon glyphicon-apple icon_image_no_link"></i>
            </figure>
            <p class="info-text">A specifically tailored diet is devised and monitored by our
                inhouse dietitian nutritionist to assist patients with their weight loss goals and to manage obesity.</p>
        </section>

        <section id="columnTwo" class="info">
            <h4 class="info-head">Health maintenance</h4>
            <figure class="img">
                <i class="glyphicon glyphicon-apple icon_image_no_link"></i>
            </figure>
            <p class="info-text">According to Traditional Chinese Medicine (TCM), foods have individual therapeutic properties which can not only be used to maintain health,
                but also to contribute to the treatment of illnesses, such as acne; anxiety; bronchitis; colds and flu.</p>
        </section>

        <section id="columnThree" class="info">
            <h4 class="info-head">Digestive Disorders</h4>
            <figure class="img">
                <i class="glyphicon glyphicon-apple icon_image_no_link"></i>
            </figure>
            <p class="info-text">Diet therapy plays an important factor in the overall care of patients with digestive disorders such as gastrointestinal disease; irritable bowel syndrome; celiac disease; Crohn’s disease; constipation; diarrhoea and stomach ulcers.</p>
        </section>
